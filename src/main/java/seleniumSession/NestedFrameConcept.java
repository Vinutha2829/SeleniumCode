...
public class NestedFrameConcept {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("inp_val")).sendKeys("vinutha");
		driver.switchTo().frame("pact2");
		driver.findElement(By.id("jex")).sendKeys("madhan");
		driver.switchTo().frame("pact3");
		driver.findElement(By.id("glaf")).sendKeys("sujith");
		//switch to parent frame
		driver.switchTo().parentFrame();
		driver.findElement(By.id("jex")).sendKeys("b");
		//switch to page
